...
data DiffCache = DiffCache
  { hieToSourceDiff :: PositionDiff.TokenDiff,
    sourceToHieDiff :: PositionDiff.TokenDiff,
...
getDiffCacheImpl path = do
  ...
  case HashMap.lookup path diffCacheMap of
    ...
    Nothing -> do
      ...
      let diffCache =
            DiffCache
              { sourceToHieDiff = PositionDiff.diffText source hieSource,
                hieToSourceDiff = PositionDiff.diffText hieSource source,
                hieToSource,
                sourceToHie
              }
